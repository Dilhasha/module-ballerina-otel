...
/**
 * A custom log formatter for formatting Otel trace log files.
 */
public class OtelTraceLogFormatter extends Formatter {
    ...
    private static String format = LogManager.getLogManager().getProperty(
            OtelTraceLogFormatter.class.getCanonicalName() + ".format");
